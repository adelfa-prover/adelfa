  ...
  Vars: D:o, L5:o, N:o, L7:o, D2:o, L4:o, L3:o, L1:o
  IH:
      forall L1, forall L2, forall L3, forall L23, forall L4, forall D1,
        forall D2,
        {D1 : append L2 L3 L23} =>
            {D2 : append L1 L23 L4}* =>
                exists L12, exists D3, exists D4,
                  {D3 : append L1 L2 L12} /\ {D4 : append L12 L3 L4}
  H2:{D2 : append L1 (cons N L7) L4}@
  H3:{L5 : list}
  H4:{L3 : list}
  H5:{L7 : list}
  H6:{N : nat}
  H7:{D : append L5 L3 L7}
  ...
  app_assoc.1>> cases H12.
  
  Subgoal app_assoc.1.1:
  
  Vars: D5:o, L6:o, N1:o, L9:o, D3:o, D:o, L5:o, N:o, D1:o, L23:o, L3:o, L2:o
  IH:
      forall L1, forall L2, forall L3, forall L23, forall L4, forall D1,
        forall D2,
        {D1 : append L2 L3 L23} =>
  ...
  H7:{cons N1 L9 : list}*
  H8:{N : nat}*
  H9:{D : append L5 L23 (cons N1 L9)}*
  H11:{D3 : append L5 L2 (cons N1 L6)}
  H13:{L6 : list}
  H14:{L3 : list}
  H15:{L9 : list}
  H16:{N1 : nat}
  H17:{D5 : append L6 L3 L9}
  
  ==================================
  {cons N1 L6 : list}
  
  Subgoal app_assoc.1.2 is:
   {nil : list}
  ...
  app_assoc.1.1>> search.
  
  Subgoal app_assoc.1.2:
  
  Vars: D3:o, D:o, L5:o, N:o, L7:o, D1:o, L23:o, L2:o
  IH:
      forall L1, forall L2, forall L3, forall L23, forall L4, forall D1,
        forall D2,
        {D1 : append L2 L3 L23} =>
  ...
  Subgoal rev_app_swap.1 is:
   {rev_app_cons N L3 L12 ba D7 D2 : rev_app (cons N L3) ba}
  
  Subgoal rev_app_swap.2 is:
   exists D5, {D5 : rev_app AB ba}
  
  rev_app_swap.1>> cases H19.
  
  Subgoal rev_app_swap.1.1:
  
  Vars: B2:o, D8:o, D9:o, N1:o, A1:o, L12:o, B1:o, D5:o, D6:o, D:o, L1:o, N:o,
          D4:o, D3:o, D2:o, D1:o, ba:o, b:o, a:o, B:o
  IH:
      forall A, forall B, forall a, forall b, forall AB, forall ba, forall D1,
        forall D2, forall D3, forall D4,
        {D1 : append A B AB}* =>
  ...
  H22:{B2 : list}
  H23:{L12 : list}
  H24:{D8 : rev_app A1 B2}
  H25:{D9 : append B2 (cons N1 nil) L12}
  
  ==================================
  {L12 : list}
  
  Subgoal rev_app_swap.1.2 is:
   {nil : list}
  ...
  rev_app_swap.1.1>> search.
  
  Subgoal rev_app_swap.1.2:
  
  Vars: B1:o, D5:o, D6:o, D:o, L1:o, N:o, D4:o, D3:o, D2:o, D1:o, ba:o, b:o, a:
          o, B:o
  IH:
      forall A, forall B, forall a, forall b, forall AB, forall ba, forall D1,
        forall D2, forall D3, forall D4,
  ...
  H14:{D5 : rev_app L1 B1}
  H15:{D6 : append B1 (cons N nil) a}
  H17:{D1 : append b B1 nil}
  H18:{D2 : append nil (cons N nil) ba}
  ...
  rev_app_swap.1>> cases H4.
  
  Subgoal rev_app_swap.1.1:
  
  Vars: D8:o, L2:o, N1:o, L5:o, D7:o, L12:o, B1:o, D5:o, D6:o, D:o, L1:o, N:o,
          L3:o, D3:o, D2:o, D1:o, a:o, B:o
  IH:
      forall A, forall B, forall a, forall b, forall AB, forall ba, forall D1,
        forall D2, forall D3, forall D4,
        {D1 : append A B AB}* =>
  ...
  H14:{D5 : rev_app L1 B1}
  H15:{D6 : append B1 (cons N nil) a}
  H17:{D1 : append (cons N1 L2) B1 L12}
  H18:{D2 : append L12 (cons N nil) (cons N1 L5)}
  H19:{D7 : rev_app L3 L12}
  H20:{L12 : list}
  H21:{L2 : list}
  H22:{a : list}
  ...
  Vars: D7:o, L12:o, B1:o, D5:o, D6:o, D:o, L1:o, N:o, L3:o, D3:o, D2:o, D1:o,
          ba:o, B:o
  IH:
      forall A, forall B, forall a, forall b, forall AB, forall ba, forall D1,
        forall D2, forall D3, forall D4,
  ...
  H13:{ba : list}
  H14:{D5 : rev_app L1 B1}
  H15:{D6 : append B1 (cons N nil) ba}
  H17:{D1 : append nil B1 L12}
  H18:{D2 : append L12 (cons N nil) ba}
  H19:{D7 : rev_app L3 L12}
  H20:{L12 : list}
  H21:{ba : list}
  ...
  rev_acc_exists.1>> cases H6.
  
  Subgoal rev_acc_exists.1.1:
  
  Vars: D:o, N:o, L4:o, L3:o, n:o, L2:o
  IH:
      forall L1, forall L2,
        {L1 : list}* =>
            {L2 : list} => exists L3, exists D1, {D1 : rev_acc L1 L2 L3}
  ...
  H9:{L3 : list}
  H10:{N : nat}
  H11:{D : rev_acc L4 (cons N (cons n L2)) L3}
  
  ==================================
  {L3 : list}
  
  Subgoal rev_acc_exists.1.2 is:
   {cons n L2 : list}
  ...
  rev_acc_exists.1.1>> search.
  
  Subgoal rev_acc_exists.1.2:
  ...
  rev_acc_rev_lem.1>> cases H3.
  
  Subgoal rev_acc_rev_lem.1.1:
  
  Vars: D4:o, N1:o, L2:o, D:o, N:o, L1:o, D2:o, ba2:o, ba:o, AB:o
  IH:
      forall a, forall B, forall AB, forall ba, forall ba2, forall D1,
        forall D2, forall D3,
        {D1 : rev_acc a B AB}* =>
  ...
  H6:{AB : list}*
  H7:{N : nat}*
  H8:{D : rev_acc L1 (cons N (cons N1 L2)) AB}*
  H9:{L2 : list}
  H10:{cons N L1 : list}
  H11:{ba2 : list}
  H12:{N1 : nat}
  H13:{D4 : rev_acc L2 (cons N1 (cons N L1)) ba2}
  
  ==================================
  {ba2 : list}
  
  Subgoal rev_acc_rev_lem.1.2 is:
   {cons N L1 : list}
  ...
  rev_acc_rev_lem.1.1>> search.
  
  Subgoal rev_acc_rev_lem.1.2:
  
  Vars: D:o, N:o, L1:o, D2:o, ba:o, AB:o
  IH:
      forall a, forall B, forall AB, forall ba, forall ba2, forall D1,
        forall D2, forall D3,
        {D1 : rev_acc a B AB}* =>
  ...
  rev_acc_rev>> cases H1.
  
  Subgoal rev_acc_rev.1:
  
  Vars: D:o, N:o, L3:o, L2:o
  H2:{L3 : list}
  H3:{nil : list}
  H4:{L2 : list}
  H5:{N : nat}
  H6:{D : rev_acc L3 (cons N nil) L2}
  
  ==================================
  {L2 : list}
  
  Subgoal rev_acc_rev.2 is:
   {nil : list}
  
  Subgoal rev_acc_rev is:
   exists D2, {D2 : rev_acc L2 nil L1}
  
  rev_acc_rev.1>> search.
  
  Subgoal rev_acc_rev.2:
