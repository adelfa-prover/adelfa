  ...
  ==================================
  {G, n1:tm, n2:of n1 T3 |- T4 : ty}
  
  Subgoal ty_unique_aux.1 is:
   exists D3, {G |- D3 : eq (arr T3 T4) (arr T3 T5)}
  ...
  ty_unique_aux.1>> weaken H5 with tm.
  ...
  ty_unique_aux.1>> weaken H6 with tm.
  ...
  ty_unique_aux.1>> weaken H14 with of n7 T3.
  
  Subgoal ty_unique_aux.1:
  
  Vars: D3:(o) -> (o) -> o, T5:o, a1:(o) -> (o) -> o, R:(o) -> o, T3:o, T4:o
  Nominals: n8:o, n7:o, n6:o, n5:o, n4:o, n3:o, n2:o, n1:o, n:o
  Contexts: G{n8, n7, n6, n5, n4, n3, n2, n1, n}:c[]
  IH:
      ctx G:c.
        forall E, forall T1, forall T2, forall D1, forall D2,
          {G |- T1 : ty} =>
  ...
  ty_unique_aux.1>> weaken H9 with tm.
  ...
  ty_unique_aux.1>> weaken H10 with tm.
  ...
  ty_unique_aux.1>> weaken H15 with of n7 T3.
