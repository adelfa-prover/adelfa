...
val try_left_unify_cpairs : used:(id * term) list -> term -> term -> (term * term) list option
val try_left_unify_list_cpairs : used:(id * term) list -> term list -> term list -> (term * term) list option
