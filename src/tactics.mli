 ...
 *)
val cases : Signature.signature -> (string * Context.ctx_schema) list -> Sequent.sequent -> string -> 
  case list
...
val apply : (string * Context.ctx_schema) list -> Sequent.sequent -> Formula.formula ->
  Formula.formula list -> Formula.formula

val apply_with : (string * Context.ctx_schema) list -> Sequent.sequent -> Formula.formula ->
            Formula.formula list -> ((Term.id * Term.term) list * (Context.ctx_var * Context.ctx_expr) list) -> Formula.formula
...
val weaken : Signature.signature -> Sequent.sequent -> Formula.formula -> Term.term -> unit
...
val inst : Signature.signature -> Sequent.sequent -> Formula.formula -> (Term.id * Term.term) list -> Formula.formula
